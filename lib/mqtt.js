...
var topic_prefix, topic_from, topic_to;
...
Mqtt.prototype.connect = function() {
  ...
  topic_prefix = config.mqtt.topic_prefix || "xiaomi";
...
Mqtt.prototype.publish = function(payload, topic) {
  const mqttTopic = (topic)
    ? topic_prefix + '/' + topic
    : topic_from;
  // console.log(mqttTopic, payload);
